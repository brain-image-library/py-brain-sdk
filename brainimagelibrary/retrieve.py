...
def by_id(bildid=None, params=None, headers=None):
	...
	try:
		...
		if 'message' in response.keys() and response['message'] == 'GET failure, no entry found':
			return {}
		else:
			return response
...
def by_directory(directory=None, params=None, headers=None):
	...
	api_url = f'https://api.brainimagelibrary.org/query/dataset?bildirectory={directory}'
